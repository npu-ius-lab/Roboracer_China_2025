...
def publish_arrow_marker(max_dir_index):
    ...
    marker = Marker()
    marker.header.frame_id = "tianracer_02/laser"
...
if __name__ == '__main__': 
  try:
    ...
    scan_sub = rospy.Subscriber('/tianracer_02/scan', LaserScan, middle_line_callback,queue_size=1)
    # drive_pub = rospy.Publisher('/tianracer_02/ackermann_cmd', AckermannDrive, queue_size=1)
    drive_pub = rospy.Publisher('/tianracer_02/ackermann_cmd_stamped', AckermannDriveStamped, queue_size=1)
